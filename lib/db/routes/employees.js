...
var _handleSPResponse = require('../utils/handleSPResponse');

var _handleSPResponse2 = _interopRequireDefault(_handleSPResponse);
...
router.get('/clockedIn', /*checkJwt, jwtAuthz(['read:info']),*/function (req, res) {
    _index2.default.sequelize.query('exec GetClockedInEmployees', { type: _index2.default.sequelize.QueryTypes.SELECT }).then(function (employees) {
        (0, _handleSPResponse2.default)(employees, req, res);
    });
});
